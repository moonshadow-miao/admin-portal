...
<script>
  import {Busi_spManage_getSpList, Busi_spManage_update, Busi_spManage_batchUpdate, Busi_spManage_batchChange} from '@/api/business'
  import Platform from '@/components/PlatformSelector/platformSelector'
  import {Alert} from 'element-ui'
  import Vue from 'vue'
  import {SP_STATUS, SP_STATUS_MAP, SP_TYPE ,LABEL_STATUS} from '@/utils/constant'
